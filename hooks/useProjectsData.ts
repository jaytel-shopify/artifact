 ...
 * Optimized to only fetch the artifacts needed for covers (max 3 per project)
...
async function fetcher(userId?: string): Promise<ProjectsData> {
  ...
  // This dramatically reduces the query size from potentially 200+ to max ~3 per project
