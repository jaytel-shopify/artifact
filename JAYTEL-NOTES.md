...
- loading transitions, nice soft fades into pages so not so jumpy
...
- add iframe indicator, and an 'open link' button for URL artifacts
- more breakpoint options for URL embeds
- or custom breakpoint option
